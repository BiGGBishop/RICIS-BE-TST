...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable("AuthorizationManufacturers", {
      ...
      dateIssue: Sequelize.DATE,
      expirationDate: Sequelize.DATE,
      nameCompany: Sequelize.STRING,
      joinDate: Sequelize.DATE,
      existDate: Sequelize.DATE,
      inspectorName: Sequelize.STRING,
      inspectorAddress: Sequelize.STRING,
      inspectorDob: Sequelize.DATE,
      inspectorEmail: Sequelize.STRING,
      inspectorTelephone: Sequelize.STRING,
      ...
      companyQualityManual: Sequelize.JSON,
      operationalProcedures: Sequelize.JSON,
      companyDocumentation: Sequelize.JSON,
      documentationQuality: Sequelize.JSON,
      designerDocumentation: Sequelize.JSON,
      weldingDocumentation: Sequelize.JSON,
      ndtDocumentation: Sequelize.JSON,
      indtDocumentation: Sequelize.JSON,
      isoCertification: Sequelize.JSON,
