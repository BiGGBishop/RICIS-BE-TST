...
/** @type {import('sequelize-cli').Migration} */
    ...
    up: async (queryInterface, Sequelize) => {
      ...
      await queryInterface.sequelize.query(`
        CREATE TYPE "enum_CompetencyCertificationLiftings_Class_Certification" AS ENUM (
            'Class A',
            'Class B',
            'Class 1',
            'Class 2'
    ...
    down: async (queryInterface, Sequelize) => {
        ...
        await queryInterface.sequelize.query(`DROP TYPE "enum_CompetencyCertificationLiftings_type_of_certification";`);
