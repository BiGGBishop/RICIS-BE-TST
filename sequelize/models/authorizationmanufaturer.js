  ...
  AuthorizationManufacturer.init(
    {
      ...
      operationalProcedures: DataTypes.STRING,
      companyDocumentation: DataTypes.STRING,
      documentationQuality: DataTypes.STRING,
      designerDocumentation: DataTypes.STRING,
      weldingDocumentation: DataTypes.STRING,
      ndtDocumentation: DataTypes.STRING,
      indtDocumentation: DataTypes.STRING,
      isoCertification: DataTypes.STRING,
